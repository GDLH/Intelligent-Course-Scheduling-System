...
class Ui_MainWindow(QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(0, 0, 631, 503))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "排课系统"))
        ...
        self.pushButton.setStyleSheet("QPushButton{font: 10pt '黑体'}")
    ...
    def succeed(self):
        ...
        self.mainWindow.setStyleSheet(qdarkstyle.load_stylesheet_pyqt5())
